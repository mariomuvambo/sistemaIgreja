...
<div class="container">
  <div class="row">
    ...
    <form action="/casamento/update/{{ $editar->id }}" method="POST"> 
          ...
          <div class="row">
            <div class="col-4">
              ...
              <input type="text" class="form-control" id="nome_noiva" name="nome_noiva" value="{{$editar->nome_noiva}}">
            </div>

            <div class="col-4">
              <label for="Nome"> Apelido do Noiva</label>
              <input type="text" class="form-control" id="apelido_noiva" name="apelido_noiva" value="{{$editar->apelido_noiva}}">
            </div>
          </div>
          <div class="row">
            <div class="col-4">
              <label for="">Nacionalidade</label>
              <input type="text" class="form-control" id="nacionalidade_noiva" name="nacionalidade_noiva" value="{{$editar->nacionalidade_noiva}}">
            </div>

            <div class="col-4">
              <label for="">Contacto</label>
              <input type="number" id="contacto_noiva" name="contacto_noiva" class="form-control" value="{{$editar->contacto_noiva}}">
            </div>
            <div class="col-4">
          ...
          <div class="row">
            ...
            <div class="col-4">
              ...
              <div class="col-1">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="batizada" id="flexRadioDefault1" value="S" value="{{$editar->batizada}}">
              ...
              <div class="col-1">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="batizada" id="flexRadioDefault1" value="N" value="{{$editar->batizada}}">
                  <label class="form-check-label" for="flexRadioDefault1">
                    Nao
                  </label>
                </div>
            ...
            <div class="col-4">
              ...
              <input type="text" class="form-control" id="local_batizada" name="local_batizada" value="{{$editar->local_batizada}}">
            </div>
          ...
          <div class="row">
            <div class="col-4">
              ...
              <input type="text" class="form-control" id="nome_noivo" name="nome_noivo"value="{{$editar->nome_noivo}}">
            </div>

            <div class="col-4">
              <label for="Nome"> Apelido do Noiva</label>
              <input type="text" class="form-control" id="apelido_noivo" name="apelido_noivo"value="{{$editar->apelido_noivo}}">
            </div>
          ...
          <div class="row">
            <div class="col-4">
              <label for="">Nacionalidade</label>
              <input type="text" class="form-control" id="nacionalidade_noivo" name="nacionalidade_noivo"value="{{$editar->nacionalidade_noivo}}">
            </div>

            <div class="col-4">
              <label for="">Contacto</label>
              <input type="number" id="contacto_noivo" name="contacto_noivo" class="form-control"value="{{$editar->contacto_noivo}}">
            </div>
            <div class="col-4">
              <label for="">Estado Civil</label>
          ...
          <div class="row">
            ...
            <div class="col-4">
              ...
              <div class="col-1">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="batizado" id="flexRadioDefault1" value="S"value="{{$editar->batizado}}">
                  <label class="form-check-label" for="flexRadioDefault1">
                    Sim
                  </label>
                </div>
              ...
              <div class="col-1">
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="batizado" id="flexRadioDefault1" value="N"value="{{$editar->batizado}}">
                  <label class="form-check-label" for="flexRadioDefault1">
                    Nao
                  </label>
                </div>
            ...
            <div class="col-4">
              <label for="" class="form-label">Local do Batismo</label>
              <input type="text" class="form-control" id="local_batizado" name="local_batizado"value="{{$editar->local_batizado}}">
            </div>
          ...
          <p>
            ...
            <input type="date" id="data_casamento" name="data_casamento" class="form-control-sm-4" style="height: 30px;" value="{{$editar->data_casamento}}">
          </p>
          <hr style="margin-top: 15px;">
        <button class="btn btn-info" type="submit" value="Atualizar casamento"> Atualizar Casamento</button>
