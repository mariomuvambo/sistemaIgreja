      ...
      <ul class="nav nav-pills justify-content-center">
        ...
        <li class="nav-item">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal1">Contactos</a></li>
          </ul>
        </li>
          <!-- Modal -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModal1Label">Contactos da Igreja</h1>
        ...
        <li class="nav-item">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="/MinisteriosRegisto/ministerio">Registar Ministérios</a></li>
        ...
        <li class="nav-item">
          <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Finanças</a>
          <ul class="dropdown-menu">

            <li><a class="dropdown-item" href="/financas/financa">Registo</a></li>
            <li>
              <hr class="dropdown-divider">
            </li>
         ...
         <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Finanças</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <span class="contato">Cell: +258 45215421</span>
                <div class="col"> <span class="contato">Fax: 88112154</span> </div>
                <a href="#" style="color: goldenrod" class="contato">email:fianancas@gmail.com</a>
              </div>
              <div class="modal-footer">
                <button class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              </div>
        ...
        <div class="dropdown">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#exampleModal2">Contactos</a></li>
            </ul>
          </li>
           <!-- Modal -->
         <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModal2Label" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModal2Label">Secretaria</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <span class="contato">Cell: +258 85554455</span>
                <div class="col"> <span class="contato">Fax: 45554545</span> </div>
        ...
        <li class="nav-item">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/Avisos/aviso">Registar</a></li>
            <li>
              <hr class="dropdown-divider">
            </li>
